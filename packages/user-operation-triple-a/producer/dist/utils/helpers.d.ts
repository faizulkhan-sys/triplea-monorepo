...
export declare function calculateGrossDailyPay(pay_period_salary: number, pay_cycle: string): number;
export declare function determinePayCycleDateRange(payCycle: string, employer_id: string): Promise<{
    startCycleDate: any;
    endCycleDate: any;
}>;
