...
__decorate([
    ...
    class_validator_1.IsNotEmpty({ message: 'Contact name is missing' }),
    class_validator_1.IsString(),
    class_validator_1.Length(4, 100, {
        message: 'Contact name must be between 4 to 100 characters long',
    }),
    __metadata("design:type", String)
], CreateUser.prototype, "contact_name", void 0);
__decorate([
    swagger_1.ApiProperty({
        description: 'Email of user',
        example: 'abc@xyz.com',
    }),
    class_validator_1.IsNotEmpty({ message: 'Email is missing' }),
...
], CreateUser.prototype, "user_type", void 0);
__decorate([
...
__decorate([
    ...
    __metadata("design:type", String)
], CreateUser.prototype, "company_name", void 0);
__decorate([
    swagger_1.ApiPropertyOptional({
    ...
    __metadata("design:type", String)
], CreateUser.prototype, "payroll_system", void 0);
__decorate([
    class_validator_1.ValidateIf((o, _) => o.employer_no !== ''),
    class_validator_1.IsString({ message: 'Time management system must be a string' }),
    __metadata("design:type", String)
], CreateUser.prototype, "time_management_system", void 0);
__decorate([
    class_validator_1.ValidateIf((o, _) => o.employer_no !== ''),
    class_validator_1.IsString({ message: 'Company internal HR must be a string' }),
    __metadata("design:type", String)
], CreateUser.prototype, "company_internalhr_system", void 0);
__decorate([
    swagger_1.ApiProperty({
    ...
    class_validator_1.IsNotEmpty(),
    __metadata("design:type", String)
], CreateUser.prototype, "phone_ext", void 0);
__decorate([
    swagger_1.ApiProperty({
...
__decorate([
    ...
    class_validator_1.IsString(),
    __metadata("design:type", String)
], CreateUser.prototype, "employer_no", void 0);
__decorate([
    swagger_1.ApiProperty({
    ...
    __metadata("design:type", String)
], CreateUser.prototype, "zip_code", void 0);
