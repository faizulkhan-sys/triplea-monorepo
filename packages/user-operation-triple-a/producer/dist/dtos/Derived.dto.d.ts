...
declare const InviteUserMobile_base: import("@nestjs/common").Type<Pick<BaseDto, "employee_email" | "employer_email">>;
...
declare const IdEmployeeDto_base: import("@nestjs/common").Type<Pick<BaseDto, "employee_id" | "employer_id" | "ssn_no">>;
