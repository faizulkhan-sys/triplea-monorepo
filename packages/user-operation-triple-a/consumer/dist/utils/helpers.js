...
exports.removeEmpty = exports.dateToString = exports.uniqueID = exports.excelPaycycleHelper = exports.formatErrors = exports.formUrlEncoded = exports.getPayComponent = exports.getAccessToken = exports.getEmployeeNames = exports.sendMailUser = exports.sendMail = exports.getEmployeeData = exports.getEmployerData = exports.fixed2DigitDecimal = exports.isFutureDate = exports.isValidDate = exports.validateUUID = exports.hasPrevious = exports.hasNext = exports.paginate = exports.addMaxTimeOnDate = exports.parseDateOnly = exports.Axios = exports.buildResponsePayload = exports.subtractDate = void 0;
...
async function sendMailUser(from, to, mailTemplate, replacements, subject) {
    return emailPool
        .queue(async (email) => await email.sendMail(to, mailTemplate, replacements, subject))
        .then(async (result) => {
...
exports.sendMailUser = sendMailUser;
