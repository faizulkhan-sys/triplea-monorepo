...
export declare function buildResponsePayload(user: Customer, accessToken: string, refreshToken?: string): AuthenticationPayload;
...
export declare function sendMail(to: string, mailTemplate: string, replacements: any, subject: string): Promise<any>;
export declare function sendMailUser(from: string, to: string, mailTemplate: string, replacements: any, subject: string): Promise<any>;
