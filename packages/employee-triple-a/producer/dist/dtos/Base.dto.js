...
__decorate([
    ...
    class_validator_1.IsNotEmpty({ message: 'Zip code must not be empty' }),
    class_validator_1.Length(5, 5, {
        message: 'Zip code must be between 5 digits long',
    }),
    __metadata("design:type", String)
], BaseDto.prototype, "zip_code", void 0);
__decorate([
    swagger_1.ApiProperty({
        name: 'Employer id',
...
__decorate([
    class_validator_1.IsNotEmpty({ message: 'idx must not be empty' }),
    class_validator_1.IsUUID('all', { each: true, message: 'Idx must be an uuid array' }),
    swagger_1.ApiProperty({
        description: 'Idx',
    }),
