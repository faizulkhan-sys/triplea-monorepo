...
let TokensService = class TokensService {
    constructor(tokens, jwt, userRepository) {
        this.userRepository = userRepository;
        this.tokens = tokens;
        this.jwt = jwt;
    }
    async generateAccessToken(user) {
        const opts = Object.assign(Object.assign({}, BASE_OPTIONS), { expiresIn: index_1.default.jwt.expiresIn, subject: String(user.id) });
    ...
    async generateRefreshToken(user, expiresIn) {
        ...
        const opts = Object.assign(Object.assign({}, BASE_OPTIONS), { expiresIn: index_1.default.jwt.expiresIn, subject: String(user.id), jwtid: String(token.id) });
    ...
    pickCustomerFields(user) {
        return js_utils_1.pick(user, ['idx', 'email']);
    }
};
